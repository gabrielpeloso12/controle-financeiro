...
begin
  frmCadFinalizador.btnEditar.Enabled := True;
  frmCadFinalizador.btnExcluir.Enabled := True;
  frmCadFinalizador.edtDescReceita.Enabled := True;
  frmCadFinalizador.edtDescReceita.SetFocus;
  ...
  frmCadFinalizador.edtDescReceita.Text := DM.queryFinalizador.FieldByName('F_DESCRICAO').Value;
end;
