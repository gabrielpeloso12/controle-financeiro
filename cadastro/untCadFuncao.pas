...
//ASSOCIA CAMPOS DO EDIT COM CAMPO DO BANCO DE DADOS
...
begin
  ...
  begin
    ...
    begin
      DM.queryCargo.Close;
      DM.queryCargo.SQL.Clear;
      DM.queryCargo.SQL.Add ('DELETE FROM CARGO WHERE C_CODIGO = :C_CODIGO');
      DM.queryCargo.ParamByName ('C_CODIGO').Value := StrToInt(edtCodigo.Text);
      DM.queryCargo.Execute;
      MessageDlg('Cargo deletado com sucesso', mtConfirmation, [mbOK], 0);
      edtDescFuncao.Text := '';
